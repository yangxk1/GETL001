...
public class LoadUtil {
    ...
    public static UnifiedGraph loadUGFromPGFiles(GetlLogger logger) throws InterruptedException {
        ...
        lpgParser.loadVertex(BASE_URL_DYNAMIC + "comment_0_0.csv", "Comment", "creationDate", LPGParser.STRING).commit2Converter();
        lpgParser.loadVertex(BASE_URL_DYNAMIC + "forum_0_0.csv", "Forum", "creationDate", LPGParser.STRING).commit2Converter();
        lpgParser.loadVertex(BASE_URL_DYNAMIC + "post_0_0.csv", "Post", "creationDate", LPGParser.STRING, "length", LPGParser.INT).commit2Converter();
        lpgParser.waitAll();
        //EDGE

...
public class CommonConstant {
    ...
    private static String JDBC_BASE_URL = "jdbc:mysql://123.57.218.144:3306/";
    ...
    public static String RESULT_JDBC_URL_2 = JDBC_BASE_URL + "result_data_2?useSSH=false";
    public static String RESULT_JDBC_URL_6 = JDBC_BASE_URL + "result_data_6?useSSH=false";

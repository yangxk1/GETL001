...
import com.getl.model.onegraph.elements.OGSimpleNode;
import com.getl.model.onegraph.elements.OGSimpleNodeBNode;
...
public class OGDataset {
     ...
     */
    public void addStatementAndAddToGraph(@NonNull OGTripleStatement statement, Resource graphName) {
